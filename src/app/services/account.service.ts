...
export class AccountService {
  ...
  url: string = 'http://localhost:5500/v1/account';
  securedUrl: string = 'http://localhost:5500/v1/secured/account';
  ...
  verifyEmail(verificationToken) {
    return this.httpClient.get(this.url + '/email/verification', {
